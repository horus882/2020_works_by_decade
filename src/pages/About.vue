<template>
  <div id="page-about" class="page">
    ...
    <section class="contact">
      ...
      <ul>
        <li><a href="mailto:info@huangyikai.com" target="_blank">E-Mail</a></li>
        <li><a href="https://www.facebook.com/huangyikai.photography/" target="_blank">Facebook</a></li>
        <li><a href="https://www.instagram.com/huangyikai_photography/" target="_blank">Instagram</a></li>
      </ul>
    </section>
    <section class="offer">
